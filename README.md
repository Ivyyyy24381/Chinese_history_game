...
总共设计并制作了 **10 个事件**，跨越 736—770 年：

> 736 落第壮游 → 744 遇李白 → 747 制举 → 751 献赋 → 755 安史 → 757 左拾遗 → 759 弃官 → 760 草堂 → 765 夔州 → 770 舟中

**61 个互动场景（phase），10 种交互类型**：explore×22、transition×18、forced_choice×6、map_travel×5、poem_compose×3（望岳/春望/登高）、comic_reveal×3（石壕村/岳阳楼/江上旧梦连环画）、exam×1（野无遗贤 8 题）、sliding_puzzle×1（三大礼赋华容道）、click_points×1（春望找茬）、escape_game×1（长安出城 Pac-Man）。全部 10 个事件均配 3 题 quiz。
