...
const styles = {
  ...
  scope: { margin: 0, fontSize: "clamp(12px, 0.833vw, 13.8px)", color: "#8B7355", textAlign: "center" },
  myScore: {
    textAlign: "center", padding: "8px 0", borderRadius: 8,
    backgroundColor: "rgba(244,208,63,0.2)", color: "#3B2510", fontSize: "clamp(12px, 0.972vw, 16.1px)",
  },
  list: { overflowY: "auto", flex: 1 },
  row: {
    display: "flex", alignItems: "center", gap: 10,
    padding: "8px 10px", borderRadius: 6, fontSize: "clamp(12px, 0.972vw, 16.1px)", color: "#3B2510",
  },
  ...
  empty: { textAlign: "center", color: "#8B7355", fontSize: "clamp(12px, 0.972vw, 16.1px)", padding: "20px 0" },
  closeBtn2: {
